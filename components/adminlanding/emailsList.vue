      ...
      <div class="px-8 pb-8">
        ...
        <div class="bg-white rounded-t-lg border border-gray-200 shadow-sm overflow-hidden">
          <div class="grid grid-cols-6 gap-4 px-6 py-4 bg-gray-50 border-b border-gray-200">
            ...
            <div class="font-semibold text-gray-600">Siuntėjas</div>
          ...
          <div v-else>
            <div 
              ...
              :key="email.id"
              class="grid grid-cols-6 gap-4 px-6 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-150"
            ...
            >
              ...
              <div class="truncate text-gray-600">
                {{ formatRecipients(email.recipient_email) }}
              </div>
...
const formatRecipients = (recipients) => {
  ...
  if (emails.length <= 1) return recipients;
...
const viewEmail = (id) => {
  console.log('Navigating to email ID:', id);
